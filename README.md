...
### :white_check_mark: 아이젠사이언스 기업과 모두의연구소 아이펠 리서치가 1달간 함께 진행한 프로젝트입니다.
...
- VLM을 활용한 2 step 파인튜닝 접근법을 제안합니다.
     - 분자화학 QA데이터를 활용한 **Instruction Tuning** , tuning된 모델을 활용하여 OCSR **CoT tuning**을 진행합니다.
- PubChem과 ChEBI에서 image-description 총 440K를 수집하고 추가로 Gemini2.5 pro를 사용하여 시각적 설명 데이터 180K를 생성했습니다.
